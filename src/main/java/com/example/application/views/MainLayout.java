...
import com.example.application.views.uploadfile.UploadfileView;
import com.example.application.views.uploadtext.UploadtextView;
...
public class MainLayout extends AppLayout {
    ...
    private AppNav createNavigation() {
        ...
        if (accessChecker.hasAccess(UploadfileView.class)) {
